...
1. 建一个html文件，随便写个h1标签：
   ...
   ![image-20220823140518434](./images/bacbc180d9a88cd06ac988ab8fab52448a35348b.png)

2. 建一个.scss后缀的文件，如input.scss，写点基本样式sass的语法：
   ![image-20220823140550201](./images/7446e8cfea1963feec70f74c98e15a5570f0a8cd.png)
...
3. 在html文件所在的路径下打开cmd命令控制符，输入：
   ...
   ![image-20220823140645814](./images/cd57c9686d892e6f30e4f15aa3124c150a3038db.png)
...
​    css文件内容如下，可以看出转换好了：
​    ![image-20220823140750386](./images/23a4e7317c5dc935065a7d17de1af039ef1fef0a.png)
...
![image-20220823173100339](./images/f18b5afe44e8a50d00093d9683a9c6965272617b.png)
...
- 保存位置
  ...
  ![image-20220823173159840](./images/50de6685454beb2c1ae13f5a12f7a70bc59d2c7d.png)
